...
void arghmm_forward_block_log(const LocalTree *tree, const ArgModel *model,
...
// use switch matrix
void arghmm_forward_switch_log(const double *col1, double* col2, 
...
{    
    ...
    stochastic_traceback_fast(&trees, &model, &matrix_list, 
