...
void remove_arg_thread(LocalTrees *trees, int remove_leaf)
{
    ...
    for (LocalTrees::iterator it=trees->begin(); it != trees->end(); ++it) {
        ...
        //printf("> %d %d %d %d, %d %p\n", remove_leaf, remove_coal, 
        //       coal_child, coal_parent, last_leaf, tree->nodes);
